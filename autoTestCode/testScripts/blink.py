# python3 -m testScripts.blink

from lib.ch32v003_test_target import Ch32V003_test_target
from lib.logic_analyzer_util import LogicAnalyzerUtil

def blink_test():
    test_ch32v003_test_target.connectPin("PD0", "304_PA0")
    test_ch32v003_test_target.connectPin("X6", "304_PA0")
    ...
    # since the PD0 of CH32V003 is connected to the PA0, check the high and low level duration of the logic analyzer capture
